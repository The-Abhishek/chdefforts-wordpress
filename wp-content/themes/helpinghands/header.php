...
<header id="sd-header" class="clearfix <?php if ( is_page() && $transp_header == '1' ) { echo 'sd-transparent-bg'; } ?>">
	...
	<div class="container sd-logo-menu">
		<div class="sd-logo-menu-content">
			<div class="sd-logo">
				<?php if ( ! empty( $logo ) ) : ?>
					<a style=" float: left; " href="<?php echo home_url( '/' ); ?>" title="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" rel="home"> <img src="<?php echo $logo; ?>" alt="<?php echo get_bloginfo( 'name' ); ?>" /></a>
				<?php else : ?>
				...
				<?php endif; ?>
				    <h3 style="display: inline;letter-spacing: 4px;text-transform: uppercase;">Center for Health and Development &#x000AE;</h3>
				<span style="display: block;margin-left: 58px;font-style: italic;font-size: 16px;margin-top: -9px;height:42px;letter-spacing: 3px;">At the Forefront of Changing Human Destinies Forever</span> 
</div><!-- sd-logo -->
