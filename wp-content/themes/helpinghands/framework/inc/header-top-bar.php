...
<div class="sd-header-top">
	<div class="container">
		...
		<?php if ( $sd_data['sd_social_icons'] == '1' ) : ?>	
			...
			?>
				<a class="sd-header-whatsapp" href="https://api.whatsapp.com/send?phone=918244265566" title="whatsapp" target="_blank" rel="nofollow"><i class="sd-link-trans fa fa-whatsapp"></i></a>
			</div>
			<!-- sd-header-social -->
		<?php endif; ?>
	</div>
